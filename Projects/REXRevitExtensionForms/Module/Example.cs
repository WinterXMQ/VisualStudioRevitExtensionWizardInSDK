...
namespace REX.AREXTemplate.Main
{
    public class DataBar : REX.Common.REXExtensionObject 
    {
    ...
    public class DataColumn : REX.Common.REXExtensionObject 
    {
    ...
    public class Structure : REX.Common.REXExtensionObject 
    {
    ...
    public class Presentation : REX.Common.REXExtensionObject 
    {
    ...
    public class Generate : REX.Common.REXExtensionObject 
    {
